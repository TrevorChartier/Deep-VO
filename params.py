...
class Parameters():
	def __init__(self):
		self.n_processors = 8
		# Path
		self.data_dir =  '/s/bach/c/under/trevor04/Documents/Classes/CS445/Project/DeepVO-pytorch/KITTI'
		...
		self.img_w = 160   # original size is about 1226
		self.img_h = 96   # original size is about 370
		self.img_means =  (-0.14157808910710584, -0.12097004731087557, -0.11408423476874663)
		self.img_stds =  (0.3199121528770875, 0.32276592868988396, 0.3267024226226063)
		...
		self.pretrained_flownet = './pretrained/flownets_EPE1.951.pth'
								# Choice:
								# None
